...
export const existencias = {
  insert: `${environment.urlBase}Existencias/Insert`,
  get: `${environment.urlBase}Existencias/Get`,
  update: `${environment.urlBase}Existencias/Update`,
  delete: `${environment.urlBase}Existencias/Delete`
}
...
export const tipoMovimientos = {
  ...
  delete: `${environment.urlBase}TipoMovimiento/Delete`
}
...
export const detalleMovimientos = {
  ...
  update: `${environment.urlBase}DetalleMovimientos/Update`,
  delete: `${environment.urlBase}DetalleMovimientos/Delete`
}
